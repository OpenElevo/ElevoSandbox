 ...
 *
 * This example demonstrates streaming command output using gRPC.
 *
...
async function main() {
  ...
  try {
    // 1. Create workspace and sandbox
    console.log('1. Creating workspace and sandbox...');
    const workspace = await client.workspace.create({ name: 'streaming-example' });
    ...
    // Cleanup workspace
    console.log('6. Cleaning up workspace...');
